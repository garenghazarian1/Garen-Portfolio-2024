      ...
      <main>
        <div className={styles.container}>
          <div className={styles.container1}>
            <div className={` ${styles.child1}`}>
              ...
              <div className={styles.childDiv}>
                <Link href="/me/mySlides" className={` ${styles.child}`}>
                  {t("slide")}
                </Link>
                <Link href="/me/myPhoto" className={` ${styles.child}`}>
                  {t("photos")}
                </Link>
                <Link href="/me/about" className={` ${styles.child}`}>
                  {t("aboutMe")}
                </Link>
                <Link href="/me/follow" className={` ${styles.child}`}>
                  {t("followMe")}
                </Link>
              </div>
            </div>
            ...
            <div className={styles.child2}>
              <div className={styles.childProject}>
                <Link
                  href="/projects"
                  className={`${bad.className} ${styles.childProjectButton} `}
                >
                  {t("projects")}
                </Link>
              </div>
              ...
              <div className={styles.childProject}>
                <div
                  className={`${bad.className} ${styles.childProjectHeader}   `}
                >
                  <h2
                    className={`${bad.className} ${styles.childProjectHeader}   `}
                  >
          ...
          <div className={styles.container1}>
            <Link
              href="/contact"
              className={`${bad.className} ${styles.child3}`}
            >
              {t("contact")}
            </Link>
            <Link
