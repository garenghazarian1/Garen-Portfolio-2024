  ...
  return (
    <>
        <div className={styles.socialLinks}>     
            ...
            <a className={styles.infoA} href="https://www.linkedin.com/in/garen-ghazarian-1692812a5/" target="_blank">{t('linkedin')}</a>
            <a className={styles.infoA} href="https://github.com/garenghazarian1" target="_blank">{t('github')}</a>
