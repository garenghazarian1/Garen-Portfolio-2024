    ...
    <div className={styles.container}>
      ...
      >
        <SwiperSlide className={styles.swiperSlide}>
          ...
          <Image  src="/001.jpg" fill alt='01.jpg'  />
          </div> 
        ...
        <SwiperSlide className={styles.swiperSlide}>
        <Image  src="/002.jpg" fill alt='02.jpg' className={styles.swiperSlideImg} />
          <div className={styles.swiperSlideText}>
          <p className={styles.swiperSlideTextP}>
        ...
        <SwiperSlide className={styles.swiperSlide}>
        <Image  src="/003.jpg" fill alt='03.jpg' className={styles.swiperSlideImg} />
          <div className={styles.swiperSlideText}>
          <p className={styles.swiperSlideTextP}>
        ...
        <SwiperSlide className={styles.swiperSlide}>
        <Image  src="/004.jpg" fill alt='04.jpg' className={styles.swiperSlideImg} />
          <div className={styles.swiperSlideTextRight}>
          <p className={styles.swiperSlideTextP}>
        ...
        <SwiperSlide className={styles.swiperSlide}>
        <Image  src="/005.jpg" fill alt='05.jpg' className={styles.swiperSlideImg} />
          <div className={styles.swiperSlideTextRight}>
          <p className={styles.swiperSlideTextP}>
...
"Later, my journey brought me to Germany, where I seized the opportunity to turn my long-time computer hobby into a formal education. I enrolled in the DCI Institute, where I studied to become a full-stack developer. Recently, I graduated and am currently engaged in a significant project."</p>
        ...
        <SwiperSlide className={styles.swiperSlide}>
        <Image  src="/006.jpg" fill alt='01.jpg' className={styles.swiperSlideImg} />
          <div className={styles.swiperSlideTextRight}>
          <p className={styles.swiperSlideTextP}>
        ...
        <SwiperSlide className={styles.swiperSlide}>
        <Image  src="/007.jpg" fill alt='01.jpg' className={styles.swiperSlideImg} />
          <div className={styles.swiperSlideText}>
          <p className={styles.swiperSlideTextP}>
